...
//  yoututbe
//
//  Created by SnoopyKing on 2017/11/16.
...
class MenuBar : UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override init(frame: CGRect) {
        ...
        addConstriantFormat(format: "H:|[v0]|", views: collectionView)
        addConstriantFormat(format: "V:|[v0]|", views: collectionView)
...
class MenuCell: BaseCell{
    ...
    override func setupViews() {
        ...
        addConstriantFormat(format: "H:[v0(28)]", views: imageView)
        addConstriantFormat(format: "V:[v0(28)]", views: imageView)
